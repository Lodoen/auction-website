...
/**
 * Shows the create auction form, if  the user is authenticated
 * @example
 * ```js
 * show.createAuction();
 * ```
...
export default function createAuction() {
  ...
  if (container) {
    ...
    mediaWrapper.setAttribute("class", "d-flex");
    ...
    secondRow.append(mediaLabel, mediaWrapper, mediaHelp, mediaListWrapper);
